...
fun main() {
    ...
    params["uri"] = "grpc+tcp://localhost:8181"
    params["adbc.flight.sql.authorization_header"] = "Bearer YOUR_AUTH_TOKEN"
    params["adbc.flight.sql.rpc.call_header.database"] = "_internal"
