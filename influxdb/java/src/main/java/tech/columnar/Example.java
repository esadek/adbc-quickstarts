...
public class Example {
  ...
  public static void main(String[] args) throws Exception {
    ...
    params.put("uri", "grpc+tcp://localhost:8181");
    params.put("adbc.flight.sql.authorization_header", "Bearer YOUR_AUTH_TOKEN");
    params.put("adbc.flight.sql.rpc.call_header.database", "_internal");
