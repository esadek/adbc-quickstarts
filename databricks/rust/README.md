...
2. Customize `src/main.rs` as needed:
    - Change the connection arguments in `opts`:
        - `OptionDatabase::Uri` is the URI for your Databricks instance. The program includes several authentication options. See the [Databricks ADBC driver documentation](https://docs.adbc-drivers.org/drivers/databricks/) for details.
